  ...
  return (
    <div className="h-full w-full text-muted flex items-center justify-center flex-col">
        ...
        <div className="flex flex-col gap-y-8 pt-4">
            <Button variant={"darkGhost"} className="p-10 justify-center md:justify-start">
                <a href="mailto:wgraham1@umd.edu" target="_blank" className="flex items-center px-3 gap-x-3">
                    ...
                    {!isMobile && <h2 className="md:text-[25px] text-lg font-medium">willgraham367@gmail.com</h2>}
                </a>
            </Button>
            <Button variant={"darkGhost"} className="p-10 justify-center md:justify-start">
            <a href="https://github.com/WillGraham36" target="_blank" className="flex items-center px-3 gap-x-3">
                    ...
                    {!isMobile && <h2 className="text-[25px] font-medium">github.com/WillGraham36</h2>}
                </a>
            </Button>
            <Button variant={"darkGhost"} className="p-10 justify-center md:justify-start">
            <a href="https://www.linkedin.com/in/will-graham-4623022a8/" target="_blank" className="flex items-center px-3 gap-x-3">
                    ...
                    {!isMobile && <h2 className="text-[25px] font-medium">linkedin.com/in/will-graham-4623022a8/</h2>}
                </a>
            </Button>
        </div>
    </div>
